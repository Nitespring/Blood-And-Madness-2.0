	   ...
	   public void tick() {
		 ...
		 //attack ticks
		  ...
		  protected void performLightAttack() {
		    	    ...
		    	    AttackHitboxHelpers.LargeAttack(DamageSource.mobAttack(mob),6.0f, 0.4f, mob, pos, 3.5f, -Math.PI/4, Math.PI/4, 1.0f, 3.0f);
		  ...
		  protected void performLargeSweepAttack() {
	    	    ...
	    	    AttackHitboxHelpers.LargeAttack(DamageSource.mobAttack(mob),10.0f,1.6f, mob, pos, 4.5f, -Math.PI/2, Math.PI/2, 1.0f, 3.0f);
		  ...
		  protected void performSweepAttackBehind() {
	    	    ...
	    	    AttackHitboxHelpers.LargeAttack(DamageSource.mobAttack(mob),9.0f,2.0f, mob, pos, 3.5f, Math.PI/4, -Math.PI/4, 1.0f, 3.0f);

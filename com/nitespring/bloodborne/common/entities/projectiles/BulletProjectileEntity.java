...
public class BulletProjectileEntity extends AbstractHurtingProjectile{
	...
	public void onHitEntity(EntityHitResult e) {
		...
		if(item == null) {
			e.getEntity().hurt(DamageSource.indirectMobAttack(this, owner), damage);
	...
	this.level.explode(this, this.position().x, this.position().y, this.position().z, 1f,false, BlockInteraction.DESTROY);
		}

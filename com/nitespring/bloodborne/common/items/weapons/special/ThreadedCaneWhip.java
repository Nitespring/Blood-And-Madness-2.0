...
public class ThreadedCaneWhip extends TrickWeapon implements IAnimatedWeapon, IAnimatable, ISyncable{
	...
	public void registerControllers(AnimationData data) {
		AnimationController<ThreadedCaneWhip> controller = new AnimationController<ThreadedCaneWhip>(this, CONTROLLER_NAME, 1, this::predicate);
	...
	public void onAnimationSync(int id, int state) {
		if (state == SWING) {
			...
			if (controller.getAnimationState() == AnimationState.Stopped) {
				...
				controller.setAnimation(new AnimationBuilder().addAnimation("animation.threaded_cane_trick.swing", false));

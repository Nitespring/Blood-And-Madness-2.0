...
public class CloakedBeastPatientGeoRenderer extends GeoEntityRenderer<CloakedBeastPatient> {
	...
	public CloakedBeastPatientGeoRenderer(EntityRendererProvider.Context renderManager)
    {
        super(renderManager, new CloakedBeastPatientModel());
        this.addLayer(new CloakedBeastPatientEyesLayer<CloakedBeastPatient>(this));
	 ...
	 private void addLayer(CloakedBeastPatientEyesLayer<CloakedBeastPatient> cloakedBeastPatientEyesLayer) {
		...
		@Override
		public RenderType getRenderType(CloakedBeastPatient animatable, ResourceLocation texture,
...
@Override
protected float getDeathMaxRotation(CloakedBeastPatient entityLivingBaseIn) {

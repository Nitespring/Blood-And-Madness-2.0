...
public class CloakedBeastPatientModel extends GeoModel<CloakedBeastPatient>
{

	public CloakedBeastPatientModel() {

	}

    @Override
    public ResourceLocation getModelResource(CloakedBeastPatient object)
    {
        return new ResourceLocation(BloodborneMod.MOD_ID, "geo/cloaked_beast_patient.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(CloakedBeastPatient object)
    {
        return new ResourceLocation(BloodborneMod.MOD_ID, "textures/entities/beast/beast_patient.png");
    }

    @Override
    public ResourceLocation getAnimationResource(CloakedBeastPatient object)
    {
    ...
    @Override
	public void setCustomAnimations(CloakedBeastPatient entity, long uniqueID, AnimationState<CloakedBeastPatient> customPredicate) {

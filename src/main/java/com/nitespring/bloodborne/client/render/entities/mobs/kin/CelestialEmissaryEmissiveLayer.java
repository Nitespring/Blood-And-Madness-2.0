...
public class CelestialEmissaryEmissiveLayer<T extends CelestialEmissary> extends GeoRenderLayer<CelestialEmissary>{

	private static final ResourceLocation LAYER = new ResourceLocation(BloodborneMod.MOD_ID, "textures/entities/kin/celestial_emissary_emissive.png");
	 //private static final ResourceLocation MODEL = new ResourceLocation(BloodborneMod.MOD_ID, "geo/celestial_emissary.geo.json");
	
	public CelestialEmissaryEmissiveLayer(GeoRenderer<CelestialEmissary> entityRendererIn) {

...
public class AshenBeastPatientEyesLayer<T extends AshenBeastPatient> extends GeoRenderLayer<AshenBeastPatient>{
	...
	public AshenBeastPatientEyesLayer(GeoRenderer<AshenBeastPatient> entityRendererIn) {
	...
	@Override
	public void render(PoseStack matrixStackIn, AshenBeastPatient entityLivingBaseIn, BakedGeoModel bakedModel, RenderType renderType,

...
public class GenericSpellProjectileRenderer extends EntityRenderer<Entity>{
	private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(BloodborneMod.MOD_ID, "textures/entities/projectiles/generic_spell_projectile.png");
	  
	  BulletModel<Entity> model;
	public GenericSpellProjectileRenderer(Context p_174008_) {
		super(p_174008_);
...
//ShulkerBulletRenderer
	...
	public void render(Entity p_115862_, float p_115863_, float p_115864_, PoseStack p_115865_, MultiBufferSource p_115866_, int p_115867_) {
	      ...
	      p_115865_.translate(0.0D, (double)0.5F, 0.0D);
	      ...
	      VertexConsumer vertexconsumer = p_115866_.getBuffer(RenderType.entityTranslucent(TEXTURE_LOCATION));
	      this.model.renderToBuffer(p_115865_, vertexconsumer, p_115867_, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
	      p_115865_.scale(3.0F, 3.0F, 3.0F);
	      //p_115865_.translate(0.0D, (double)0.2F, 0.0D);

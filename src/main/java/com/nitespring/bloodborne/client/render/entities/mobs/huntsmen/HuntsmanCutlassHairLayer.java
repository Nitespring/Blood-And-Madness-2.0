...
public class HuntsmanCutlassHairLayer<T extends HuntsmanCutlassEntity> extends GeoRenderLayer<HuntsmanCutlassEntity>{
	...
	private static final ResourceLocation LAYER = new ResourceLocation(BloodborneMod.MOD_ID, "textures/entities/huntsman/huntsman_hair_black.png");
	 private static final ResourceLocation MODEL = new ResourceLocation(BloodborneMod.MOD_ID, "geo/huntsman_cutlass.geo.json");
	
	public HuntsmanCutlassHairLayer(GeoRenderer<HuntsmanCutlassEntity> entityRendererIn) {
	...
	@Override
	public void render(PoseStack poseStack, HuntsmanCutlassEntity animatable, BakedGeoModel bakedModel, RenderType renderType,

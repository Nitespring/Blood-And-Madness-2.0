...
public class BeastPatientEyesLayer<T extends BeastPatient> extends GeoRenderLayer<BeastPatient>{
	...
	private static final ResourceLocation LAYER = new ResourceLocation(BloodborneMod.MOD_ID, "textures/entities/beast/beast_patient_eyes.png");
	 private static final ResourceLocation MODEL = new ResourceLocation(BloodborneMod.MOD_ID, "geo/beast_patient.geo.json");
	
	public BeastPatientEyesLayer(GeoRenderer<BeastPatient> entityRendererIn) {
	...
	@Override
	public void render(PoseStack matrixStackIn, BeastPatient entityLivingBaseIn, BakedGeoModel bakedModel, RenderType renderType,

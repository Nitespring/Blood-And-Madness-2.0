			 ...
			 if (stack.hasTag() && stack.getTag().contains("BBLevel"))
				{
			            ...
			            return Component.literal(Component.translatable(this.getDescriptionId(stack)).getString().concat(string));

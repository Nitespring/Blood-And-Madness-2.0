...
public class BlossomedEyeItem extends Item{
	

	public BlossomedEyeItem(Properties p_41383_) {
		super(p_41383_);
	...
	public void releaseUsing(ItemStack stackIn, Level worldIn, LivingEntity playerIn, int p_77615_4_) {
	    	...
	    	BlossomedEyeEntity summons = new BlossomedEyeEntity(ProjectileInit.BLOSSOMED_EYE.get(), worldIn);
	   ...
	   @OnlyIn(Dist.CLIENT)
		public void appendHoverText(ItemStack stack, Level p_77624_2_, List<Component> tooltip,
			...
			super.appendHoverText(stack, p_77624_2_, tooltip, p_77624_4_);
				 ...
				 String text = "\u00A75" + "Oh Kos... or some say Kosm... Grant Us Eyes!";
				 tooltip.add(Component.literal(text));
				 
				 String info = "\u00A78\u00A7oSummons the mad rector of the School of Mensis, the dreamer Micolash";
				 tooltip.add(Component.literal(info));
			    
				 String text1 = "\u00A75\u00A7oIt is said that to ascend to the Gods, one must grow Eyes on the Inside";

...
public class BeastCutterWhip extends TrickWeapon implements IAnimatedWeapon, GeoItem{
	private static final RawAnimation ANIM = RawAnimation.begin().thenPlay("animation.beastcutter.swing");
	...
	public void registerControllers(ControllerRegistrar data) {
		AnimationController<BeastCutterWhip> controller = new AnimationController<BeastCutterWhip>(this, CONTROLLER_NAME, 1, state -> PlayState.STOP)

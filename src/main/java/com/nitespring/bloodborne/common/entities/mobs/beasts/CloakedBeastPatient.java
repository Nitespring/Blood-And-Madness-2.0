...
public class CloakedBeastPatient extends AbstractBloodborneEntity implements GeoEntity{

	protected AnimatableInstanceCache factory = GeckoLibUtil.createInstanceCache(this);
	
	public CloakedBeastPatient(EntityType<? extends PathfinderMob> p_i48575_1_, Level p_i48575_2_) {
	...
	protected int getBnMDefaultTeam() {
	 ...
	 public static  AttributeSupplier.Builder setCustomAttributes(){
	  ...
	  public static boolean checkCloakedBeastPatientSpawnRules(EntityType<? extends AbstractBloodborneEntity> e, 
	     ...
	     {  	 
	    	return checkBnMMonsterSpawnRules(e, access, type, pos, r) && 
	    			CommonConfig.should_cloaked_beast_patient_spawn.get();
	     }
	...
	public void tick() {
	  ...
	  @Override
		public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_21434_, DifficultyInstance p_21435_,
			  ...
			  this.getAttributes().getInstance(Attributes.MAX_HEALTH).setBaseValue(CommonConfig.cloaked_beast_patient_hp.get());;
	   ...
	   public class AttackGoal extends Goal{
	    ...
	    protected void performAttack() {
	   	 ...
	   	 if(mob.getCombatState()==1) {
		   	AttackHitboxHelpers.LargeAttack(mob.damageSources().mobAttack(mob), (float) this.mob.getAttributeValue(Attributes.ATTACK_DAMAGE)*1.2f, (float) this.mob.getAttributeValue(Attributes.ATTACK_KNOCKBACK)*1.5f, mob, pos, 2.0f, -Math.PI/4, Math.PI/4, -1.0f, 1.5f,MobEffects.POISON,80,1,false);	
		   	    }else {

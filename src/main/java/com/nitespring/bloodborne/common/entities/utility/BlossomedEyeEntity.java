...
public class BlossomedEyeEntity extends Entity{

	
	public BlossomedEyeEntity(EntityType<?> p_19870_, Level p_19871_) {
	...
	public void tick() {
		...
		if(tickCount>=60) {
			MicolashBossEntity entity = new MicolashBossEntity(EntityInit.MICOLASH.get(), this.level());

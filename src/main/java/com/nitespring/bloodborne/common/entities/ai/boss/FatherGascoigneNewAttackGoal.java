	   ...
	   public void tick() {
		 ...
		 //attack ticks
		  ...
		  protected void performLightAttack() {
		    	    ...
		    	    AttackHitboxHelpers.LargeAttack(mob.damageSources().mobAttack(mob),8.0f, 0.4f, mob, pos, 3.5f, -Math.PI/4, Math.PI/4, 1.0f, 3.0f, true);
		  ...
		  protected void performLargeSweepAttack() {
	    	    ...
	    	    AttackHitboxHelpers.LargeAttack(mob.damageSources().mobAttack(mob),12.0f,1.6f, mob, pos, 4.5f, -Math.PI/2, Math.PI/2, 1.0f, 3.0f, true);
		  ...
		  protected void performSweepAttackBehind() {
	    	    ...
	    	    AttackHitboxHelpers.LargeAttack(mob.damageSources().mobAttack(mob),10.0f,2.0f, mob, pos, 3.5f, Math.PI/4, -Math.PI/4, 1.0f, 3.0f, true);

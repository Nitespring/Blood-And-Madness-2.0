...
public class ChurchDoctor extends AbstractBloodborneEntity implements GeoEntity{

	protected AnimatableInstanceCache factory = GeckoLibUtil.createInstanceCache(this);
	
	public ChurchDoctor(EntityType<? extends PathfinderMob> p_i48575_1_, Level p_i48575_2_) {
	...
	public int bloodRes() {return 200;}
	 ...
	 @Override
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(1, new ChurchDoctor.AttackGoal(this));
	 ...
	 protected SoundEvent getAmbientSound() {
	   ...
	   public static boolean checkChurchDoctorSpawnRules(EntityType<? extends AbstractBloodborneEntity> e, 
	     ...
	     {  	 
	    	return checkBnMMonsterSpawnRules(e, access, type, pos, r) && 
	    			CommonConfig.should_church_doctor_spawn.get();
	     }
	   ...
	   @Override
		public SpawnGroupData finalizeSpawn(ServerLevelAccessor p_21434_, DifficultyInstance p_21435_,
			  ...
			  this.getAttributes().getInstance(Attributes.MAX_HEALTH).setBaseValue(CommonConfig.church_doctor_hp.get());;

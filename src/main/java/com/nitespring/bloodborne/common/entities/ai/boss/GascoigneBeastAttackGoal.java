	   ...
	   public void tick() {
		 ...
		 //attack ticks
		  ...
		  protected void performLightAttack() {
		    	    ...
		    	    AttackHitboxHelpers.LargeAttack(mob.damageSources().mobAttack(mob),8.0f, 0.6f, mob, pos, 5.0f, -Math.PI/4, Math.PI/4, 1.0f, 3.0f);
		  ...
		  protected void performLargeSweepAttack() {
	    	    ...
	    	    AttackHitboxHelpers.LargeAttack(mob.damageSources().mobAttack(mob),10.0f,1.6f, mob, pos, 3.0f, -3/2*Math.PI, 3/2*Math.PI, 1.0f, 3.0f);

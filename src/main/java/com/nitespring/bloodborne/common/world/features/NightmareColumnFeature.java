package com.nitespring.bloodborne.common.world.features;
...
public class NightmareColumnFeature extends Feature<ColumnFeatureConfiguration> {
	   ...
	   public NightmareColumnFeature(Codec<ColumnFeatureConfiguration> p_65153_) {
	      super(p_65153_);
	   }
	         ...
	         if (blockpos1 != null) {
	            ...
	            for(BlockPos.MutableBlockPos blockpos$mutableblockpos = blockpos1.mutable(); j >= 0; --j) {
	               if (isAirOrLavaOcean(p_65168_, p_65169_, blockpos$mutableblockpos)) {
	                  this.setBlock(p_65168_, blockpos$mutableblockpos, BlockInit.NIGHTMARE_STONE.get().defaultBlockState());
	                  blockpos$mutableblockpos.move(Direction.UP);
	                  flag = true;
	               } else {
	                  if (!p_65168_.getBlockState(blockpos$mutableblockpos).is(BlockInit.NIGHTMARE_STONE.get())) {
	                     break;
	                  }
